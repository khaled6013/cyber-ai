    ...
    return (
        <div className="bg-black py-10 ">
            <div className="w-10/12 mx-auto px-10">
                ...
                <div className="w-0.5 h-full bg-linear-to-r from-[#E03609] to-[#F0B71F] absolute top-0 left-[130px] "></div>
                <div className="w-0.5 h-full bg-linear-to-r from-[#E03609] to-[#F0B71F] absolute top-0 right-[130px] "></div>
            </div>
